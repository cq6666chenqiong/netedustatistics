...
public class StudentScoreExcelController {
    ...
    public String getScoreByGradeExcel(){
        ...
        Map<String,Object> membersScore = parseMemberScore(qryscoreMap,qrycourseMap);
        return "";
    }

    public String parseMemberScoreByBQ(Map<String,Object> membersScore){
        Set<String> bingquSet;
        Iterator<String> itbingqu = membersScore.keySet().iterator();
